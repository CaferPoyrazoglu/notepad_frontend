  ...
  >
    <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-3 md:px-6 2xl:px-11">
      <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
        ...
        <button
          class="z-99999 block rounded-sm border p-1.5 shadow-sm border-strokedark bg-boxdark lg:hidden"
          @click="
            () => {
        ...
        >
          <span class="relative block h-5.5 w-5.5 cursor-pointer">
            <span class="du-block absolute right-0 h-full w-full">
              <span
                class="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm delay-[0] duration-200 ease-in-out bg-white"
